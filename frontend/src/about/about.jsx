    ...
    render() {
        return (
            <div>
                ...
                <h2>Descrição</h2>
                <p>
                    O projeto foi desenvolvido com base no conteúdo ministrado
                    pelo professor Leonardo Moura Leitao da Cod3R Cursos.
                    
                    O intuito do projeto consiste fixar conteúdo aprendido ao 
                    longo do curso.
                </p>
